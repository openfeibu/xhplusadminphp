...
class AlipayServiceProvider extends ServiceProvider
{
	...
	public function register()
	{
		...
		{
			$alipay_config = array_merge($app->config->get('alipay-telecom-wap'),$app->config->get('alipay'));
			$alipay = new \App\services\AlipayWapService($alipay_config);
		...
		{
			$alipay_config = array_merge($app->config->get('alipay-refund'),$app->config->get('alipay'));
			$alipay = new \App\services\AlipayRefundService($alipay_config);
