...
@section('content')
    <div class="pageheader">
        ...
        {!! Breadcrumbs::render('admin-topic-create') !!}
    </div>
        ...
        <div class="row">
            <div class="col-sm-12 col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <form class="form-horizontal form-bordered" action="{{ route('admin.topic.store') }}" method="POST">
                        <input type="hidden" name="tid" value="{{$topics['tid']}}">
                        <div class="panel-body panel-body-nopadding">
							<input type="text"  name="uid" value="{{$topics['uid']}}" style="display:none" >
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="nickname"
                                           ...
                                           data-original-title="不可编辑" value="{{$topics['nickname']}}" readOnly="true" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="type"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="不可编辑" value="{{$topics['type']}}" readOnly="true" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="content"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="不可编辑" value="{{$topics['content']}}" readOnly="true" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="view_num"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="" value="{{$topics['view_num']}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="comment_num"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="" value="{{$topics['comment_num']}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="favourites_count"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="" value="{{$topics['favourites_count']}}">
                                </div>
                            </div>
