        ...
        <div class="row">
            <div class="col-sm-9 col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <form class="form-horizontal form-bordered" action="{{ route('admin.setting.shippingConfigUpdate') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="panel-body panel-body-nopadding">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="checkbox">配送费</label>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="checkbox">最高重量</label>
                                <div class="col-sm-6">
                                   <input type="text"  data-toggle="tooltip" name="weight"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="不可重复" value="{{ $setting->weight }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="checkbox">超出重量kg/元</label>
                                <div class="col-sm-6">
                                   <input type="text"  data-toggle="tooltip" name="outweight"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="不可重复" value="{{ $setting->outweight }}">
                                </div>
                            </div>
