...
@section('content')
    ...
    <div class="contentpanel panel-email">
        ...
        <div class="row">
            @include('admin._partials.paper-left-menu')
            <div class="col-sm-10 col-lg-10">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">{{$paper['type']}}文案编辑</h4>
                    </div>

                    <form class="form-horizontal form-bordered" action="{{ route('admin.paper.faq_store') }}" method="POST">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text"  data-toggle="tooltip" name="type"
										   ...
										   data-original-title="" value="{{$paper['type']}}">
								</div>
							</div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="url"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="" value="{{$paper['url']}}">
                                </div>
                            </div>

                            <input type="text" name="id" value="{{$paper['id']}}" style="display:none">
                        ...
                        <div class="panel-footer">
                            <div class="row">
                                <div class="col-sm-6 col-sm-offset-3">
                                    ...
                                    <a class="btn btn-primary" href="{{ route($route) }}" >取消</a>
                                </div>
                            </div>
                        </div>
                        <!-- panel-footer -->
