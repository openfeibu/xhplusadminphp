...
@section('content')
    <div class="pageheader">
        ...
        {!! Breadcrumbs::render('admin-order-refund') !!}
    </div>
        ...
        <div class="row">
            <div class="col-sm-9 col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <form class="form-horizontal form-bordered" action="{{ route('admin.order.refundHandle') }}" method="POST"  target="_blank">
                        ...
                        <div class="panel-body panel-body-nopadding">						
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-6">
									<textarea class="form-control" rows="3" name="WIDdetail_data">{{ $order->detail_data }}</textarea>
