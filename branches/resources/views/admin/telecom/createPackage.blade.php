...
@section('content')
    <div class="pageheader">
        ...
        {!! Breadcrumbs::render('admin-telecomPackage-create') !!}
    </div>
            ...
            <div class="col-sm-9 col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">添加套餐</h4>
                    </div>

                    <form class="form-horizontal form-bordered" action="{{ route('admin.telecomPackage.store') }}" method="POST">
