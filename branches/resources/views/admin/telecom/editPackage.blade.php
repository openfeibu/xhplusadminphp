...
@section('content')
    <div class="pageheader">
        ...
        {!! Breadcrumbs::render('admin-telecomPackage-edit') !!}
    </div>
        ...
        <div class="row">
            <div class="col-sm-9 col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <form class="form-horizontal form-bordered" action="{{ route('admin.telecomPackage.update',['id'=>$package->package_id]) }}" method="POST">
