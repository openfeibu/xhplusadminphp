...
@section('content')
    <div class="pageheader">
        ...
        {!! Breadcrumbs::render('admin-association_info-create') !!}
    </div>
        ...
        <div class="row">
            <div class="col-sm-12 col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <form class="form-horizontal form-bordered" action="{{ route('admin.association_info.store') }}" method="POST">

                        <div class="panel-body panel-body-nopadding">
							<input type="text" name="iid" value="{{ isset($association_info['iid']) ? $association_info['iid'] : '' }}" style="display:none">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="uid"
                                           ...
                                           data-original-title="" value="{{ isset($association_info['uid']) ? $association_info['uid'] : '' }}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="title"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="" value="{{ isset($association_info['title']) ? $association_info['title'] : '' }}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="content"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="" value="{{ isset($association_info['content']) ? $association_info['content'] : '' }}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="img_url"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="" value="{{ isset($association_info['img_url']) ? $association_info['img_url'] : '' }}">
                                </div>
                            </div>
