...
@section('content')
    <div class="pageheader">
        ...
        {!! Breadcrumbs::render('admin-association_activity-create') !!}
    </div>
        ...
        <div class="row">
            <div class="col-sm-12 col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <form class="form-horizontal form-bordered" action="{{ route('admin.association_activity.store') }}" method="POST"  enctype="multipart/form-data">
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control input-sm" name="aid" id="aid">
                                        @foreach($associations as $association)
                                            <option value="{{$association->aid}}">{{$association->aname}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="uid"
                                           ...
                                           data-original-title="" value="{{ isset($association_activity['uid']) ? $association_activity['uid'] : '' }}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="title"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="" value="{{ isset($association_activity['title']) ? $association_activity['title'] : '' }}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="content"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="" value="{{ isset($association_activity['content']) ? $association_activity['content'] : '' }}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="start_time"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="" value="{{ date('Y-m-d H:i:s')}}">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="place"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="" value="{{ isset($association_activity['place']) ? $association_activity['place'] : '' }}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="file"  data-toggle="tooltip" name="activity_url"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="" value="{{ isset($association_activity['img_url']) ? $association_activity['img_url'] : '' }}">
                                </div>
                            </div>
