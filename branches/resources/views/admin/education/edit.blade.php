...
@section('content')
    <div class="pageheader">
        ...
        {!! Breadcrumbs::render('admin-education-edit') !!}
    </div>
            ...
            <div class="col-sm-9 col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">编辑教育机构</h4>
                    </div>

                    <form class="form-horizontal form-bordered" action="{{ route('admin.education.update') }}" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="{{$education->edu_id}}" />
                        <div class="panel-body panel-body-nopadding">
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-6">
                                   <input type="text"  data-toggle="tooltip" name="name"
                                           ...
                                           data-original-title="不可重复" value="{{ $education->name }}">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{ $education->logo_url }}" width="200"/>
                                    <input type="hidden" name="logo_url" value="{{ $education->logo_url }}" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="checkbox"></label>
                                <div class="col-sm-6">
                                    <img src="{{ $education->img_url }}" width="200"/>
                                    <input type="hidden" name="img_url" value="{{ $education->img_url }}" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="checkbox">描述</label>
                                <div class="col-sm-6">
                                    <textarea name="desc"  data-trigger="hover" class="form-control tooltips">{{ $education->desc }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="checkbox">详情</label>
                                <div class="col-sm-6">
                                    <textarea name="content"  data-trigger="hover" class="form-control tooltips" style="height:500px;">{{ $education->content }}</textarea>
                                </div>
                            </div>
