...
@section('content')
    <div class="pageheader">
        ...
        {!! Breadcrumbs::render('admin-education-editPro') !!}
    </div>
        ...
        <div class="row">
            <div class="col-sm-9 col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <form class="form-horizontal form-bordered" action="{{ route('admin.education.updatePro') }}" method="POST" enctype="multipart/form-data">
