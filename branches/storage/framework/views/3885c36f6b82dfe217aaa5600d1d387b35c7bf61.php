                                ...
                                <tbody>
                               	<?php foreach($realnames as $realname): ?>
                                    <tr>
										...
										<td><?php echo e($realname->name); ?></td>
										<td><?php echo e($realname->ID_Number); ?></td>
                                        <td>
											
											<img id="img_pic" style="width:80px;height:50px;" src="<?php echo e($realname->pic1); ?>" data-toggle="modal" data-target="#myModal<?php echo e($realname->id); ?>"/>
										</td>
										<td>
											<a  ><img style="width:80px;height:50px;" src="<?php echo e($realname->pic2); ?>"  data-toggle="modal" data-target="#myModal2<?php echo e($realname->id); ?>"/></a>
										</td>
                                        <td>
											<?php
                                        ...
                                        <td style="width:250px;text-align:right">
                                            <?php if(empty($realname->realname)): ?>
                                            <a data-target="#myModal_pass<?php echo e($realname->id); ?>" data-toggle="modal" class="btn btn-white btn-xs"><i class="fa fa-pencil"></i> 通过</a>
                                            <a href="" class="btn btn-white btn-xs" data-target="#myModal_fail<?php echo e($realname->id); ?>" data-toggle="modal" ><i class="fa fa-pencil"></i> 不通过   </a>
                                            <?php endif; ?>                                     
                                    ...
                                    <!-- 模态框（Modal） -->
                                    <form action="<?php echo e(route('admin.user.real_pass')); ?>" method="post">
                                        <div class="modal fade" id="myModal_pass<?php echo e($realname->id); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" style="height:400px;width:500px;">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-header">
                                                        ...
                                                        <input type="text" type="hidden" name="uid" value="<?php echo e($realname->uid); ?>" style="display:none">
                                                    </div>
                                    ...
                                    <!-- 模态框（Modal） -->
                                    <form  action="<?php echo e(route('admin.user.real_fail')); ?>" method="post">
                                        <div class="modal fade" id="myModal_fail<?php echo e($realname->id); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
									...
									<div class="modal fade" id="myModal<?php echo e($realname->id); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
										<div class="modal-dialog" style="height:500px;width:700px;">
											<div class="modal-content">
												...
												<a href="<?php echo e($realname->pic1); ?>"><img id="img_pic" style="width:600px;height:400px;margin-left:50px;" src="<?php echo e($realname->pic1); ?>" /></a> 
									...
									<div class="modal fade" id="myModal2<?php echo e($realname->id); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
										<div class="modal-dialog" style="height:500px;width:700px;">
											<div class="modal-content">
												...
												<a href="<?php echo e($realname->pic2); ?>"><img id="img_pic" style="width:600px;height:400px;margin-left:50px;" src="<?php echo e($realname->pic2); ?>" /></a> 
