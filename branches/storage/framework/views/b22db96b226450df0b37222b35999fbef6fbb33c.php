<?php $__env->startSection('content'); ?>
    <div class="pageheader">
        ...
        <?php echo Breadcrumbs::render('admin-role-edit'); ?>
            ...
            <div class="col-sm-9 col-lg-10">
                ...
                <div class="panel panel-default">
                    ...
                    <form class="form-horizontal form-bordered"
                          action="<?php echo e(route('admin.role.update',['id'=>$role->id])); ?>" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" data-toggle="tooltip" name="name"
                                           ...
                                           data-original-title="不可重复" value="<?php echo e($role->name); ?>">
                                </div>
                            </div>
