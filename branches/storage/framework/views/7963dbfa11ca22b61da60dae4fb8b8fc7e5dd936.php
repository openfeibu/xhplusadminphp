        ...
        <div class="row">
            <div class="col-sm-12 col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <form class="form-horizontal form-bordered" action="<?php echo e(route('admin.chickenSoup.store')); ?>" enctype="multipart/form-data" method="POST">
							...
							<div class="form-group">
								<div class="col-sm-6">
									<input type="text"  data-toggle="tooltip" name="id"
										   ...
										   data-original-title="不可编辑" value="<?php echo e(isset($chickenSoup['csid']) ? $chickenSoup['csid'] : ''); ?>" readonly="true" style="display:none">
								</div>
							</div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="title"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="" value="<?php echo e(isset($chickenSoup['title']) ? $chickenSoup['title'] : ''); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="file"  data-toggle="tooltip" name="background_url"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="" value="<?php echo e(isset($chickenSoup['background_url']) ? $chickenSoup['background_url'] : ''); ?>">
                                </div>
                            </div>
                            ...
                            <!-- <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="content"
                                           data-trigger="hover" class="form-control tooltips" value="<?php echo e(isset($chickenSoup['content']) ? $chickenSoup['content'] : ''); ?>">
                                </div>
                            </div> -->
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-sm-offset-3">
                                    <button class="btn btn-primary">保存</button>
                                     <a class="btn btn-primary" href="<?php echo e(route('admin.paper.chickenSoup')); ?>" >取消</a>
                                </div>
                            </div>
                        </div><!-- panel-footer -->
