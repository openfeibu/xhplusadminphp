<?php $__env->startSection('content'); ?>
    <div class="pageheader">
        ...
        <?php echo Breadcrumbs::render('admin-permission-edit'); ?>
        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-lg-10">
                ...
                <div class="panel panel-default">
                    ...
                    <form class="form-horizontal form-bordered" action="<?php echo e(route('admin.permission.update',['id'=>$permission->id])); ?>" method="POST">
                        ...
                        <div class="panel-body panel-body-nopadding">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <?php echo $permissionPresenter->topPermissionSelect($permission->fid); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="name"
                                           ...
                                           data-original-title="不可重复,不可点击路由输入`#`" value="<?php echo e($permission->name); ?>" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="description" value="<?php echo e($permission->description); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="icon"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="图标名称,去fa-前缀" value="<?php echo e($permission->icon); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <select class="form-control input-sm" name="is_menu">
                                        <option value="1" <?php echo e($permission->is_menu ? 'selected':''); ?>>是</option>
                                        <option value="0" <?php echo e($permission->is_menu ? '':'selected'); ?>>否</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <input type="text" class="form-control" name="sort"
                                           value="<?php echo e($permission->sort); ?>">
                                </div>
                            </div>
