<?php $__env->startSection('content'); ?>
    <div class="pageheader">
        ...
        <?php echo Breadcrumbs::render('admin-telecomOrder-edit'); ?>
        ...
        <div class="row">
            <div class="col-sm-9 col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <form class="form-horizontal form-bordered" action="<?php echo e(route('admin.telecomOrder.update',['id'=>$order->id])); ?>" method="POST">
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-6">
									<input type="text"  data-toggle="tooltip" name="dormitory_no"
                                           data-trigger="hover" class="form-control tooltips"
                                           value="<?php echo e($order->dormitory_no); ?>">
                                </div>
                            </div>  
							<div class="form-group">
                                ...
                                <div class="col-sm-6">
									<input type="text"  data-toggle="tooltip" name="student_id"
                                           data-trigger="hover" class="form-control tooltips"
                                           value="<?php echo e($order->student_id); ?>">
                                </div>
                            </div>  
							<div class="form-group">
                                ...
                                <div class="col-sm-6">
									<input type="text"  data-toggle="tooltip" name="telecom_outOrderNumber"
                                           data-trigger="hover" class="form-control tooltips"
                                           value="<?php echo e($order->telecom_outOrderNumber); ?>">    
                                </div>
                            </div>  
