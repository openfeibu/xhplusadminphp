<?php $__env->startSection('content'); ?>
    <div class="pageheader">
        ...
        <?php echo Breadcrumbs::render('admin-topic-comment_edit'); ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text"  data-toggle="tooltip" name="uid"
										   ...
										   data-original-title="" value="<?php echo e($comments->uid); ?>" readOnly="true" >
								</div>
							</div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="comment_content"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="" value="<?php echo e($comments->topic_content); ?>" readOnly="true" >
                                </div>
                            </div>
