<?php $__env->startSection('content'); ?>
    <div class="pageheader">
        ...
        <?php echo Breadcrumbs::render('admin-topic-edit'); ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text"  data-toggle="tooltip" name="uid"
										   ...
										   data-original-title="" value="<?php echo e(isset($topics['uid']) ? $topics['uid'] : ''); ?>" >
								</div>
							</div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="nickname"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="" value="<?php echo e(isset($topics['nickname']) ? $topics['nickname'] : ''); ?>">
                                </div>
                            </div>
                                ...
                                <div class="col-sm-2">
                                    <select class="form-control input-sm" name="type" >
                                        <?php foreach($topic_types as $topic_type): ?>
                                            <option value="<?php echo e($topic_type->type); ?>"><?php echo e($topic_type->type); ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="content"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="" value="<?php echo e(isset($topics['content']) ? $topics['content'] : ''); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="view_num"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="" value="<?php echo e(isset($topics['view_num']) ? $topics['view_num'] : ''); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="comment_num"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="" value="<?php echo e(isset($topics['comment_num']) ? $topics['comment_num'] : ''); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="favourites_count"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="" value="<?php echo e(isset($topics['favourites_count']) ? $topics['favourites_count'] : ''); ?>">
                                </div>
                            </div>
