        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-lg-10">
                ...
                <div class="panel panel-default">
                    ...
                    <form class="form-horizontal form-bordered" action="<?php echo e(route('admin.admin_user.store')); ?>" method="POST">
                        ...
                        <div class="panel-body panel-body-nopadding">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <?php echo $rolePresenter->rolesCheckbox(); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  data-toggle="tooltip" name="email"
                                           data-trigger="hover" class="form-control tooltips"
                                           data-original-title="不可重复" value="<?php echo e(old('email')); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <select class="form-control input-sm" name="is_super">
                                        <option value="1" <?php echo e(old('is_super') == 1 ? 'selected':''); ?>>是</option>
                                        <option value="0" <?php echo e(old('is_super') == 0 ? 'selected':''); ?>>否</option>
                                    </select>
                                </div>
                            </div>
