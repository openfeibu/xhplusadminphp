...
<head lang="en">
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo e(asset('main/css/common.css')); ?>">
    <script src="<?php echo e(asset('main/js/jquery.js')); ?>"></script>
    <script src="<?php echo e(asset('main/js/js.js')); ?>"></script>
    <script>
        $(function(){
...
<section class="cj">
    <div class="cj_content">
        <ul class="cj_block">
            ...
            <li id="2" class="thanks"><span><img src="<?php echo e(asset('main/images/icon1.png')); ?>"> </span></li>
            <li id="3" class="grade"><span>20<br>积分</span></li>
            <li id="4" class="thanks mR0"><span><img src="<?php echo e(asset('main/images/icon2.png')); ?>"></span></li>
            ...
            <li id="10" class="thanks"><span><img src="<?php echo e(asset('main/images/icon2.png')); ?>"></span></li>
            <li id="9" class="prize"><span>雨伞</span></li>
            <li id="8" class="thanks"><span><img src="<?php echo e(asset('main/images/icon1.png')); ?>"></span></li>
