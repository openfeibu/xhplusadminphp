<?php $__env->startSection('content'); ?>
    <div class="pageheader">
        ...
        <?php echo Breadcrumbs::render('admin-order-refund'); ?>
        ...
        <div class="row">
            <div class="col-sm-9 col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <form class="form-horizontal form-bordered" action="<?php echo e(route('admin.order.refundHandle')); ?>" method="POST"  target="_blank">
                        ...
                        <div class="panel-body panel-body-nopadding">						
							<div class="form-group">
                                ...
                                <div class="col-sm-6">
									<input type="text"  data-toggle="tooltip" name="WIDbatch_num"
                                           ...
                                           value="<?php echo e($order->batch_num); ?>"> 
                                </div>
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-6">
									<textarea class="form-control" rows="3" name="WIDdetail_data"><?php echo e($order->detail_data); ?></textarea>
