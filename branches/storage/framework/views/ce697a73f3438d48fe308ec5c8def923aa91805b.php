...
<body  style="background-image:url(<?php echo e(asset('images/book.jpg')); ?>);background-size: 100% auto;">
    <div class="author_title">
        <b>校汇鸡汤发布系统</b>
    </div>
	<form class="" action="<?php echo e(route('admin.chickenSoup.store')); ?>" enctype="multipart/form-data" method="POST" style="height:auto;">
        <input type="text" name="uid" id="title" value="<?php echo e($uid); ?>" style="display:none">
        <div style="float:left" class="chickenSoup_left">
            ...
            <div class="chickenSoup_background">
                <span>背景图片:</span>
                <img id="background_img"  src="<?php echo e(asset('images/add_img.png')); ?>" alt="" onclick="background_url.click()">
